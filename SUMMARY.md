...
* [Extra materiaal](express.js/extra-materiaal/README.md)
  * [Cookies](express.js/extra-materiaal/cookies.md)
  * [Authenticatie en Autorisatie](express.js/extra-materiaal/authenticatie-en-autorisatie/README.md)
    * [JSON Web Token (JWT)](express.js/extra-materiaal/authenticatie-en-autorisatie/json-web-token-jwt/README.md)
      * [jsonwebtokens NPM package](express.js/extra-materiaal/authenticatie-en-autorisatie/json-web-token-jwt/jsonwebtokens-npm-package.md)
      * [jsonwebtokens veilig opslaan](express.js/extra-materiaal/authenticatie-en-autorisatie/json-web-token-jwt/jsonwebtokens-opslaan.md)
    * [Environment Variables](express.js/extra-materiaal/authenticatie-en-autorisatie/environment-variables.md)
    * [body-parser NPM package](express.js/extra-materiaal/authenticatie-en-autorisatie/body-parser-npm-package.md)
  * [MySQL Connector](express.js/extra-materiaal/mysql-connector/README.md)
    * [queries uitvoeren](express.js/extra-materiaal/mysql-connector/queries.md)
    * [prepared statements](express.js/extra-materiaal/mysql-connector/prepared-statements.md)
    * [als onderdeel van een Express applicatie](express.js/extra-materiaal/mysql-connector/als-onderdeel-van-een-express-applicatie.md)
  * [CORS](express.js/extra-materiaal/cors.md)
